...
class Certificate
{
	...
	function __construct()
	{
		...
		$skeleton = assetFile("template/2020.jpg");
	...
	{
		$font = assetFile("madena-parlling.ttf", "fonts");
	...
	{
		$font = assetFile("berlin-sans-fb-demi-bold.ttf", "fonts");
	...
	{
		$font = assetFile("meiryob.ttc", "fonts");
